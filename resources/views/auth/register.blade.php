...
<head>
  ...
  <title>Bagas Blog | Registration</title>
  ...
  <div class="register-box-body">
    ...
    @csrf
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Full name" id="name" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
