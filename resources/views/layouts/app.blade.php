...
<head>
    ...
    <title>Bagas Blog | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-lg"><b>BAGAS</b> BLOG</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/"><i class="fa fa-home"></i> <span>Post</span></a></li>
        <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="/ca">Article</a></li>
            <li><a href="/createcat">Category</a></li>
        </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
